...
export const metadata = {
  title: "About Nimbus Boilers | Gas Safe Boiler Engineers Scunthorpe",
  description: "Meet Bryan Whiteley, director of Nimbus Boilers. 15+ years experience providing reliable Worcester Bosch boilers in Scunthorpe and North Lincolnshire."
};
        ...
        >
          ...
          <motion.div className="bg-white rounded-xl shadow-md p-8 mb-8" variants={itemVariants}>
            ...
            <p className="text-gray-700 mb-4">
              With over 15 years of experience in the heating industry, Nimbus Boilers specializes in gas boiler installations and maintenance.
          ...
          <motion.div className="bg-white rounded-xl shadow-md p-8" variants={itemVariants}>
            ...
            <p className="text-gray-700 mb-4">
              Founded in North Lincolnshire, Nimbus Boilers has built a reputation for quality workmanship and exceptional customer service.
